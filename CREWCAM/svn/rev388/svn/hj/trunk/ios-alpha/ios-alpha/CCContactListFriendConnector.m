...
- (NSArray *) loadFriends
{
    ...
    for(int contactIndex = 0;contactIndex < ABAddressBookGetPersonCount(addressBook); contactIndex++)
    {
        ...
        {
            [contacts addObject:[[CCContactListPerson alloc] initWithFirstName:firstNameString andLastName:lastNameString andPhoneNumber:phoneNumberString]];
        }
        else if (emailAddressString != nil)
        {
            [contacts addObject:[[CCContactListPerson alloc] initWithFirstName:firstNameString andLastName:lastNameString andEmailAddress:emailAddressString]];
        }
    }
