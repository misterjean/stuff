...
- (void)viewDidLoad
{
    ...
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(CCVideoPushNotificationReceived:) name:@"CCVideoPushNotification" object:nil];
    
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(CCCommentPushNotificationReceived:) name:@"CCCommentPushNotification" object:nil];
...
- (void) CCVideoPushNotificationReceived:(NSNotification *)CCVideoPushNotification
{
    ...
    {
        if ([(CCCrewViewController*)currentVC crewForView] != [[[[CCCoreManager sharedInstance] server] currentUser] getCrewFromObjectID:[[CCVideoPushNotification userInfo] objectForKey:@"ID"]])
        {
            [[self navigationController] popToRootViewControllerAnimated:NO];
            
            [self loadViewForCrew:[[[[CCCoreManager sharedInstance] server] currentUser] getCrewFromObjectID:[[CCVideoPushNotification userInfo] objectForKey:@"ID"]] Animated:YES];
        }
    }
    else
    {
