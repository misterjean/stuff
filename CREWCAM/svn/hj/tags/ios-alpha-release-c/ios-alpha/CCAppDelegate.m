...
- (void)applicationDidEnterBackground:(UIApplication *)application
{
    ...
    [[NSNotificationCenter defaultCenter] postNotificationName:@"CleanUpTableNotification" object:nil];
    
    [[CCCoreManager sharedInstance] recordMetricEvent:@"Backgrounded Application" withProperties:nil];
}
