...
@synthesize isLoadingForNotification;
...
- (void) awakeFromNib
{
    ...
    [self setIsLoadingForNotification:NO];
}
...
- (IBAction) onBackButtonPressed:(id)sender 
{
    ...
    [[NSNotificationCenter defaultCenter] postNotificationName:CC_STOP_PLAYING_VIDEOS_IN_CREW object:nil];
} 
