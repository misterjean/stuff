...
typedef enum {
    changeUsernamePassword = 1,
} alertViewTags;

@interface CCParseServer : NSObject <CCServer, MFMessageComposeViewControllerDelegate, PF_FBRequestDelegate, CCCrewcamAlertViewDelegate>
{    
    ...
    CCBooleanResultBlock                    changeUsernameAndPasswordBlockPointerHolder;
    NSString                                *changeUsernameAndPasswordPasswordHolder;
