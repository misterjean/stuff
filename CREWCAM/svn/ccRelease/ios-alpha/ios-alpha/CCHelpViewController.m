...
static NSInteger numberOfTutorialPages = 6;
...
{
    [[CCCoreManager sharedInstance] recordMetricEvent:CC_VIEWED_HELP_SCREEN withProperties:nil];
}
- (void)viewDidUnload
{
...
- (void)loadScrollViewWithPage:(int)page
{
    ...
    if (helpPageController.view.superview == nil)
    {
        ...
        switch (page) {
            ...
            case 3:
            {
                [[helpPageController tutorialImage] setImage:[UIImage imageNamed:@"CC_tutorial-04"]];
                break;
            }
            case 4:
            {
                [[helpPageController tutorialImage] setImage:[UIImage imageNamed:@"CC_tutorial-05"]];
                break;
            }
            case 5:
            {
                [[helpPageController tutorialImage] setImage:[UIImage imageNamed:@"CC_tutorial-06"]];
                break;
            }
            default:
                break;
