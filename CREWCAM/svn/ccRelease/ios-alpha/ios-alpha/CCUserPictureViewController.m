 ...
 didFinishPickingMediaWithInfo: (NSDictionary *) info 
{
    ...
    if (takenWithCamera)
    {
        [[CCCoreManager sharedInstance] recordMetricEvent:CC_PROFILE_PICTURE_CHANGE_CAM withProperties:nil];
        UIImageWriteToSavedPhotosAlbum(uneditedPicture, nil, nil, nil);
    }
    else
    {
        [[CCCoreManager sharedInstance] recordMetricEvent:CC_PROFILE_PICTURE_CHANGE_ALBUM withProperties:nil];
    }
