...
- (void) didReceiveMemoryWarningHandler
{
    ...
    [[[[self server] currentUser] ccCrews] removeAllObjects];
...
- (void) handlePush:(NSDictionary *)userInfo
{
    ...
    if ([[userInfo objectForKey:@"type"] intValue] == CCInvitePush)
    {
...
- (void)recordMetricEvent:(NSString *)event withProperties:(NSDictionary *)properties
{
    ...
    {
        [logger logAtLogLevel:ccLogLevelWarning message:@"Skipping event, as the user hasn't been authenticated yet."];
    }
    else
    {
