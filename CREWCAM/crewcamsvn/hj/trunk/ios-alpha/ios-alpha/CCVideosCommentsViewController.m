    ...
    {        
        if ([[alertView getTextField] text] && !
            ...
            [[[CCCoreManager sharedInstance] server] addNewCommentToVideo:videoForView inCrew:crewForView withText:[[alertView getTextField] text] withBlockOrNil:^(BOOL succeeded, NSError *error)
            {
                if (!succeeded)
                {
                    CCCrewcamAlertView * alert = [[CCCrewcamAlertView alloc] initWithTitle:@"Uh oh..." message:@"Error adding your comment." withTextField:NO delegate:self cancelButtonTitle:@"You suck." otherButtonTitles:nil, nil];
        ...
        {
            CCCrewcamAlertView * alert = [[CCCrewcamAlertView alloc] initWithTitle:@"Uh oh..." message:@"Don't Put Null Messages." withTextField:NO delegate:self cancelButtonTitle:@"You suck." otherButtonTitles:nil, nil];
